...
describe('express rest api server', () => {
  ...
  it('post object', (done) => {
    superagent.post(`http://localhost:${port}/collections/users`)
      .send({
        name: 'John',
        email: 'john@rpjs.co'
      })
  ...
  it('retrieves an object', (done) => {
    superagent.get(`http://localhost:${port}/collections/users/${id}`)
      .end((err, res) => {
        expect(err).to.eql(null);
  ...
  it('retrieves a collection', (done) => {
    superagent.get(`http://localhost:${port}/collections/users`)
      .end((err, res) => {
        expect(err).to.eql(null);
  ...
  it('updates an object', (done) => {
    superagent.put(`http://localhost:${port}/collections/users/${id}`)
      .send({
        name: 'Peter',
  ...
  it('removes an object', (done) => {
    superagent.del(`http://localhost:${port}/collections/users/${id}`)
      .end((err, res) => {
        expect(err).to.eql(null);
        expect(typeof res.body).to.eql('object');
        expect(res.body.msg).to.eql('success');
